...
| 2 | `@starwind-ui/react + runtime` | 162.1 KiB | 655.2 KiB | All Starwind React public root exports with the runtime bundled. |
| 3 | `@base-ui/react` | 160.1 KiB | 488.6 KiB | All Base UI React public root exports. |
| 4 | `@starwind-ui/runtime` | 124.7 KiB | 521.0 KiB | Runtime package alone, without the React adapter. |
| 5 | `@starwind-ui/react (adapter only)` | 34.6 KiB | 141.1 KiB | React adapter overhead with runtime externalized. |
...
| --- | ---: | ---: | ---: | ---: | --- |
| All-three overlap | 26 | 104.7 KiB | 97.5 KiB | 139.8 KiB | Only Starwind components with both a Zag and Base UI equivalent. |
| Starwind/Zag overlap | 28 | 116.6 KiB | 109.7 KiB | N/A | Only Starwind components with a Zag equivalent. |
| Starwind/Base UI overlap | 29 | 112.7 KiB | N/A | 143.4 KiB | Only Starwind components with a Base UI equivalent. |
...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| All-three overlap | Starwind | 26 | 240.0 KiB | 104.7 KiB | 135.3 KiB (56.4%) | 4.0 KiB |
...
| Starwind/Zag overlap | Starwind | 28 | 255.0 KiB | 116.6 KiB | 138.5 KiB (54.3%) | 4.2 KiB |
| Starwind/Zag overlap | Zag React | 28 | 395.9 KiB | 109.7 KiB | 286.3 KiB (72.3%) | 3.9 KiB |
| Starwind/Base UI overlap | Starwind | 29 | 253.0 KiB | 112.7 KiB | 140.3 KiB (55.4%) | 3.9 KiB |
...
| `alert-dialog` | `@zag-js/dialog` | `@base-ui/react/alert-dialog` | 7.4 KiB | 16.1 KiB | 22.4 KiB | Zag reuses its dialog machine for alert-dialog behavior. |
...
| `checkbox` | `@zag-js/checkbox` | `@base-ui/react/checkbox` | 6.9 KiB | 8.2 KiB | 7.9 KiB |  |
| `checkbox-group` | `@zag-js/checkbox` | `@base-ui/react/checkbox-group` | 7.8 KiB | 8.2 KiB | 4.0 KiB | Starwind and Base UI expose a group wrapper; Zag uses the checkbox machine. |
| `collapsible` | `@zag-js/collapsible` | `@base-ui/react/collapsible` | 4.2 KiB | 7.5 KiB | 7.1 KiB |  |
| `combobox` | `@zag-js/combobox` | `@base-ui/react/combobox` | 23.9 KiB | 29.3 KiB | 49.0 KiB |  |
| `context-menu` | `@zag-js/menu` | `@base-ui/react/context-menu` | 20.2 KiB | 28.3 KiB | 50.7 KiB | Zag models context-menu through the menu package. |
| `dialog` | `@zag-js/dialog` | `@base-ui/react/dialog` | 6.9 KiB | 16.1 KiB | 22.5 KiB |  |
| `drawer` | `@zag-js/drawer` | `@base-ui/react/drawer` | 7.4 KiB | 25.5 KiB | 37.2 KiB |  |
| `dropzone` | `@zag-js/file-upload` | N/A | 5.7 KiB | 11.5 KiB | N/A | Maps to Zag file-upload; no Base UI file upload/dropzone export. |
| `field` | N/A | `@base-ui/react/field` | 9.5 KiB | N/A | 9.2 KiB | Base UI has field primitives; Zag has no field machine. |
| `input` | N/A | `@base-ui/react/input` | 2.0 KiB | N/A | 9.2 KiB | Base UI has input primitives; Zag has no input machine. |
| `input-otp` | `@zag-js/pin-input` | `@base-ui/react/otp-field` | 6.7 KiB | 9.0 KiB | 8.5 KiB | Equivalent naming differs: Zag pin-input, Base UI otp-field. |
| `menu` | `@zag-js/menu` | `@base-ui/react/menu` | 19.7 KiB | 28.3 KiB | 50.0 KiB |  |
| `popover` | `@zag-js/popover` | `@base-ui/react/popover` | 15.5 KiB | 26.4 KiB | 39.8 KiB |  |
| `preview-card` | `@zag-js/hover-card` | `@base-ui/react/preview-card` | 14.2 KiB | 20.2 KiB | 32.3 KiB | Equivalent naming differs: Zag hover-card. |
| `progress` | `@zag-js/progress` | `@base-ui/react/progress` | 2.7 KiB | 6.4 KiB | 3.3 KiB |  |
| `radio` | `@zag-js/radio-group` | `@base-ui/react/radio` | 6.1 KiB | 8.9 KiB | 7.8 KiB | Zag's radio support is represented through radio-group. |
| `radio-group` | `@zag-js/radio-group` | `@base-ui/react/radio-group` | 8.4 KiB | 8.9 KiB | 7.0 KiB |  |
| `scroll-area` | `@zag-js/scroll-area` | `@base-ui/react/scroll-area` | 4.6 KiB | 10.4 KiB | 8.0 KiB |  |
| `select` | `@zag-js/select` | `@base-ui/react/select` | 23.9 KiB | 28.6 KiB | 43.9 KiB |  |
| `slider` | `@zag-js/slider` | `@base-ui/react/slider` | 8.7 KiB | 12.7 KiB | 14.6 KiB |  |
| `switch` | `@zag-js/switch` | `@base-ui/react/switch` | 6.1 KiB | 8.2 KiB | 6.1 KiB |  |
...
| `tooltip` | `@zag-js/tooltip` | `@base-ui/react/tooltip` | 14.5 KiB | 18.5 KiB | 33.4 KiB |  |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| `@starwind-ui/astro` | 0.1.0-beta.1 | 195.2 KiB | 20.5 KiB | 31.6 KiB | 234.3 KiB | Source-published Astro package; measured published .astro/.ts source payload, not compiled Astro output. |
| `@starwind-ui/runtime` | 0.1.0-beta.1 | 516.6 KiB | 119.5 KiB | 180.4 KiB | 983.3 KiB |  |
| `@starwind-ui/react` | 0.1.0-beta.1 | 181.3 KiB | 42.8 KiB | 70.6 KiB | 541.2 KiB |  |
