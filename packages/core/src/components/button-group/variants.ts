  ...
  variants: {
    orientation: {
      horizontal: [
        ...
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:rounded-l-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:border-l-0",
        "[&>*:not(:last-child):not(:has(+_script:last-child))[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:rounded-r-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:rounded-l-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:border-l-0",
        "[&>*:not(:last-child):not(:has(+_script:last-child))[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:rounded-r-none",
      ],
      vertical: [
        "flex-col",
        ...
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:rounded-t-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:border-t-0",
        "[&>*:not(:last-child):not(:has(+_script:last-child))[data-slot=dropdown-menu]_>_[data-sw-menu-trigger]]:rounded-b-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:rounded-t-none",
        "[&>*:not(:first-child)[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:border-t-0",
        "[&>*:not(:last-child):not(:has(+_script:last-child))[data-slot=dropdown-menu]_>_*_>_[data-sw-menu-trigger]]:rounded-b-none",
      ],
    },
  },
  defaultVariants: {
