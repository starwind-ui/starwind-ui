...
<div {...rest} data-sw-alert-dialog-portal="" data-sw-part="portal" data-placement="pending" data-sw-portal-placement="framework" data-disabled={disabled ? "" : undefined} {@attach attachPortal}>{@render children?.()}</div>
