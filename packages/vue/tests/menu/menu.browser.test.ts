...
testAcceptedModelPublication({
  ...
  initial: false,
  accepted: true,
  tree: () => renderMenu({ portalDisabled: true }),
  root: "[data-sw-menu]",
  act: (root) => root.querySelector<HTMLElement>("[data-sw-menu-trigger]")!.click(),
                    ...
                    h(MenuPopup, null, () =>
                      kind === "checkbox"
                        ...
                        : h(
                            ...
                            () => [
                              h(MenuRadioItem, { value: "a", closeOnClick: false }, () => "A"),
                              h(MenuRadioItem, { value: "b", closeOnClick: false }, () => "B"),
                            ],
                          ),
                    ),
                  ),
                      ...
                      : kind === "checkbox"
                        ...
                        : h(
                            ...
                            () => [
                              h(MenuRadioItem, { value: "a", closeOnClick: false }, () => "A"),
                              h(MenuRadioItem, { value: "b", closeOnClick: false }, () => "B"),
                              h(MenuRadioItem, { value: "c", closeOnClick: false }, () => "C"),
                            ],
                          ),
                  ),
                ),
