...
let instance: ReturnType<typeof createAlertDialog> | undefined;
...
function handleOpenChange(nextOpen: boolean, detail: AlertDialogOpenChangeDetails): void {
...
function handleCloseComplete(detail: AlertDialogCloseCompleteDetails): void {
...
function setupRuntime(recreatedOpen?: boolean): void {
  ...
  instance = createAlertDialog(element, {
