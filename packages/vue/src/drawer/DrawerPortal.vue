...
const root = inject(DrawerContext);
if (!root) throw new TypeError("DrawerPortal must be nested inside DrawerRoot.");
const owner = Symbol("DrawerPortal");
...
<template>
  <Teleport :to="props.container" :disabled="props.disabled || !root.mounted.value">
    <div ref="element" v-bind="attrs" data-sw-drawer-portal data-sw-part="portal">
      <slot />
    </div>
  </Teleport>
</template>
