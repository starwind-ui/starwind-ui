<script module lang="ts">
  ...
  export type FieldContentProps = Omit<Omit<HTMLAttributes<HTMLDivElement>, "children"> & { children?: Snippet; ref?: (element: HTMLDivElement | null) => void; "data-slot"?: string }, "size"> & VariantProps<typeof fieldContent>;
</script>
...
<div
  class={fieldContent({ "class": cx(className) })}
  {...rest}
