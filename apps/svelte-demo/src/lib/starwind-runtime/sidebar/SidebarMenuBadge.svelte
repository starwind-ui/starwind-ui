<script module lang="ts">
  ...
  export type SidebarMenuBadgeProps = SvelteHTMLElements["div"] & {children?:Snippet; "data-slot"?:string;  ref?:HTMLDivElement;};
</script>

<script lang="ts">
  let {
    "data-slot": dataSlot = "sidebar-menu-badge",
    "class": className,
    ref = $bindable(),
    "children": children,
    ...rest
...
<div
  class={sidebarMenuBadge({ "class": cx(className) })}
