<script module lang="ts">
  ...
  export type SidebarFooterProps = SvelteHTMLElements["div"] & {children?:Snippet; "data-slot"?:string;  ref?:HTMLDivElement;};
</script>

<script lang="ts">
  let {
    "data-slot": dataSlot = "sidebar-footer",
    "class": className,
    ref = $bindable(),
    "children": children,
    ...rest
...
<div
  class={sidebarFooter({ "class": cx(className) })}
  data-sidebar={"footer"}
  {...rest}
  data-slot={dataSlot}
  bind:this={ref}
