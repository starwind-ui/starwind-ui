...
export async function writeReactPrimitiveFile(
  ...
  await writeGeneratedFile(
    dir,
    fileName,
    applyReactPortalImportCanonicalization(applyReactRefCleanup(applyReactEffectTiming(contents))),
  );
}
...
export function renderNativeOverlayControlFile(tsHeader: string): string {
  return `${tsHeader}import * as React from "react";
