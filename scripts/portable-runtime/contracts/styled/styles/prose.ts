export const proseStyles = [
  ...
  "   * Colors",
  "   * =================== */",
  "  --sw-prose-color: var(--prose-color, --alpha(var(--foreground) / 80%));",
  "  --sw-prose-heading-color: var(--prose-heading-color, var(--foreground));",
  "  --sw-prose-list-marker-color: var(--prose-list-marker-color, var(--muted-foreground));",
  "",
  "  /* ===================",
  "   * Headings",
  "   * =================== */",
  ...
  "   * Links",
  "   * =================== */",
  "  --sw-prose-link-color: var(--prose-link-color, var(--foreground));",
  "  --sw-prose-link-decoration-color: var(",
  "    --prose-link-decoration-color,",
  "    var(--primary-accent)",
  "  );",
  "  --sw-prose-link-hover-color: var(--prose-link-hover-color, var(--primary-accent));",
  "",
  "  /* ===================",
  "   * Strong/Bold",
  "   * =================== */",
  "  --sw-prose-strong-color: var(--prose-strong-color, var(--foreground));",
  "  --sw-prose-strong-weight: var(--prose-strong-weight, 600);",
  "",
  "  /* ===================",
  "   * Blockquote",
  "   * =================== */",
  "  --sw-prose-blockquote-color: var(--prose-blockquote-color, var(--foreground));",
  "  --sw-prose-blockquote-border-color: var(--prose-blockquote-border-color, var(--border));",
  "  --sw-prose-blockquote-border-width: var(--prose-blockquote-border-width, 4px);",
  "",
  "  /* ===================",
  "   * Inline Code",
  "   * =================== */",
  "  --sw-prose-code-bg: var(--prose-code-bg, var(--muted));",
  "  --sw-prose-code-color: var(--prose-code-color, var(--foreground));",
  ...
  "   * Pre / Code Blocks",
  "   * =================== */",
  "  --sw-prose-pre-border-color: var(--prose-pre-border-color, var(--border));",
  "  --sw-prose-pre-border-radius: var(--prose-pre-border-radius, var(--radius-md));",
  "",
  "  /* ===================",
  "   * Tables",
  "   * =================== */",
  "  --sw-prose-table-heading-color: var(--prose-table-heading-color, var(--foreground));",
  "  --sw-prose-table-border-color: var(--prose-table-border-color, var(--border));",
  "",
  "  /* ===================",
  "   * Media (images, video, etc.)",
  "   * =================== */",
  "  --sw-prose-media-border-width: var(--prose-media-border-width, 0px);",
  "  --sw-prose-media-border-color: var(--prose-media-border-color, var(--border));",
  "  --sw-prose-media-border-radius: var(--prose-media-border-radius, 0);",
  "",
  "  /* ===================",
  "   * Mark/Highlight",
  "   * =================== */",
  "  --sw-prose-highlight-color: var(--prose-highlight-color, var(--foreground));",
  "  --sw-prose-highlight-bg-color: var(",
  "    --prose-highlight-bg-color,",
  "    --alpha(var(--warning) / 30%)",
  "  );",
  "",
  "  /* ===================",
  "   * Base styles",
  ...
  "    0 2px 0 color-mix(in srgb, var(--foreground) 10%, transparent); */",
  "}",
  "",
  "/* --------------------------------------------------------------------------",
  ...
  "  --sw-details-border-color: var(--border);",
  "  --sw-details-border-color-hover: var(--primary-accent);",
  "",
