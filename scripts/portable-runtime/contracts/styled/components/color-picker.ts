...
function colorPickerRootNode(floating: boolean, inline: boolean): RenderNode {
  return primitive(
    ...
    [
      ...
      { name: "value", value: variable("value"), frameworks: ["react", "vue", "svelte"] },
  ...
  components: [
    {
      ...
      props: {
        ...
        fields: [
          ...
          { name: "open", optional: true, type: "boolean", frameworks: ["react", "vue", "svelte"] },
      ...
      destructure: {
        props: [
          { name: "value", frameworks: ["react", "vue", "svelte"] },
          ...
          { name: "open", frameworks: ["react", "vue", "svelte"] },
          ...
          { name: "onValueChange", frameworks: ["react", "vue", "svelte"] },
          { name: "onValueCommitted", frameworks: ["react", "vue", "svelte"] },
          { name: "onFormatChange", frameworks: ["react", "vue", "svelte"] },
          { name: "onOpenChange", frameworks: ["react", "vue", "svelte"] },
          { name: "onCloseComplete", frameworks: ["react", "vue", "svelte"] },
          ...
          then: [colorPickerRootNode(false, true)],
          else: [
            {
              ...
              attrs: [
                ...
                { name: "open", value: variable("open"), frameworks: ["react", "vue", "svelte"] },
