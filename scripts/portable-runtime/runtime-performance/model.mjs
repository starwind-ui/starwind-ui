...
export const scenarioRows = defineRuntimePerformanceScenarios([
  ...
  },
  {
    ...
    sampleCount: 5,
    type: "hover",
    details: "Open select, verified pointer/mouse update sweep across 1000 items",
  },
  {
    key: "menu-open",
    category: "baseline-open",
  ...
  },
  {
    ...
    sampleCount: 5,
    type: "hover",
    details: "Open menu, verified pointer/mouse update sweep across 1000 items",
  },
  {
    key: "combobox-open",
  ...
  },
  {
    ...
    sampleCount: 5,
    type: "hover",
    details: "Open combobox, verified pointer/mouse update sweep across 1000 items",
  },
  {
  ...
  },
  {
    ...
    sampleCount: 5,
    type: "submenu-hover",
    details: "Open submenu, verified pointer/mouse update sweep across 1000 submenu items",
  },
  {
