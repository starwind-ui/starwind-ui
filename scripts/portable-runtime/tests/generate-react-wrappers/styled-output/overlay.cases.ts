...
export async function assertReactStyledOverlayOutput(outputRoot: string): Promise<void> {
  ...
  expect(popoverTrigger).toContain("className={triggerClassName}");
  expect(popoverTrigger).not.toContain("className={popoverTrigger({ class: className })}");
  ...
  expect(navigationMenuTrigger).toContain("className={triggerClassName}");
  ...
  const reactAsChildBranch = navigationMenuTrigger.slice(
    navigationMenuTrigger.indexOf("if (asChild) {"),
    navigationMenuTrigger.lastIndexOf("\n  return ("),
  );
  expect(reactAsChildBranch).toContain("className={triggerClassName}");
  expect(reactAsChildBranch).not.toContain("navigationMenuTrigger(");
  expect(reactAsChildBranch).not.toContain("NavigationMenuPrimitive.Icon");
  expect(reactAsChildBranch).not.toContain("ChevronDown");
  ...
  expect(tooltipTrigger).toContain("ref={ref}");
