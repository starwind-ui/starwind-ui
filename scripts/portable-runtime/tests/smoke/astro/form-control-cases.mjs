...
import {
  verifyAstroMobileSelectCases,
  verifyAstroSelectComboboxCases,
} from "./form-control/select-combobox.mjs";
...
export async function verifyAstroFormControlCases({ browser, page, url }) {
  ...
  await verifyAstroMobileSelectCases({ browser, url });
